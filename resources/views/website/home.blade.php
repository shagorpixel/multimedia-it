...
@section('content')
  <!--heading Serction Start Section Start-->
        ...
        <div class="my-4">
            <main class="grid grid-cols-4 items-center">
                ...
                <div class="col-span-4 md:col-span-2">
                    <img class="w-full rounded-lg" src="{{asset('website/images/blog-1.jpg')}}" alt="">
                </div>
            </main>
        </div>
    </div>
...
<div class="px-8 md:px-16 lg:px-32 py-10 md:py-20">
    <div>
        <h3 class="text-4xl font-medium my-4">Service Features</h3>
        <p>Discover a world of possibilities and explore our full suite of IT services you need to thrive in the digital world. Experience the difference with our expert solutions.</p>
    </div>
...
<!-- Marketing Features Section End -->
 ...
 <!--Happy Client brand Section Start-->
<div class="px-8 md:px-16 lg:px-32 py-10 md:py-20 bg-gray-100">
    ...
    <div class="my-6 flex flex-wrap justify-evenly">
        <img src="website/images/asana-logo.png" alt="asana-logo" class="w-40 h-10 object-cover">
        <img src="website/images/Allianz-Partners-Logo-ITA.png" alt="Allianz-Partners-Logo-ITA"
            class="w-88 h-10 object-cover">
        <img src="website/images/amazon logo.png" alt="amazon logo" class="w-88 h-12 object-cover">
        <img src="website/images/finnair-logo-1.png" alt="finnair-logo-1" class="w-88 h-8 object-cover">
        <img src="website/images/samsung logo.png" alt="samsung logo" class="w-40 h-10 object-cover">
    </div>
</div>
<!-- Happy Client brand Section End -->
...
<div class="px-8 md:px-16 lg:px-32 py-10 md:py-20">
    <div class="grid grid-cols-2">
        ...
        <img  src="website/images/trust.png" alt="pointing-left" class="col-span-2 sm:col-span-1 max-w-96 mx-auto">
    </div>
</div>
...
<div class="px-8 md:px-16 lg:px-32 py-10 md:py-20 bg-gray-100">
    ...
    <div class="grid grid-cols-3 gap-4">
        <div class="rounded-md shadow-lg border-2 col-span-3 md:col-span-1">
            <img src="website/images/blog-1.jpg" alt="blog-1" class="h-56 w-full object-cover">
        ...
        <div class="rounded-md shadow-lg border-2 col-span-3 md:col-span-1">
            <img src="website/images/blog-2.jpg" alt="blog-2" class="h-56 w-full object-cover">
            <div class="m-4 flex justify-between">
                <div class="h-6">
                    <svg class="w-6 h-5 inline align-top" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                        xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="rounded-md shadow-lg border-2 col-span-3 md:col-span-1">
            <img src="website/images/blog-3.jpg" alt="blog-3" class="h-56 w-full object-cover">
            <div class="m-4 flex justify-between">
                <div class="h-6">
                    <svg class="w-6 h-5 inline align-top" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                        xmlns="http://www.w3.org/2000/svg">
...
<div class="px-8 md:px-16 lg:px-32 py-10 md:py-20 bg-gray-100">
    <div class="grid grid-cols-2 gap-8">
        <img src="website/images/testimonial.jpg" alt="testimonial" class="col-span-2 md:col-span-1">
        <div class="col-span-2 md:col-span-1">
            ...
            <div class="flex justify-start">
                <img src="website/images/man-1.jpg" alt="man-1" class="rounded-full shadow-lg w-24 h-24">
                <div class="m-6">
